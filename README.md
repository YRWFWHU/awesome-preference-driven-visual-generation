...
| <a id="hrfd"></a>[Bridging the Intention-Expression Gap: Aligning Multi-Dimensional Preferences via Hierarchical Relevance Feedback in Text-to-Image Diffusion](https://arxiv.org/abs/2603.14936) | 2026 · arXiv · preprint | likes dislikes, reference target; prompt rewriting | Code: Not found as of 2026-09-21 | Infers feature-level preferences from session-specific likes and dislikes and rewrites prompts through a coarse-to-fine hierarchy without model training. |
| <a id="appo"></a>[Preference-Guided Prompt Optimization for Text-to-Image Generation](https://doi.org/10.1145/3772318.3791443) | 2026 · CHI 2026 · published | likes dislikes, reference target; prompt rewriting | [Code](https://github.com/ZhipengLi-98/APPO) · [Project](https://siplab.org/projects/Preference-Guided_Prompt_Optimization) · (partial) | Uses binary image selections to adapt prompt search through retention, evolutionary expansion and preference-based textual refinement. |
| <a id="multibo"></a>[Personalized Image Generation via Human-in-the-loop Bayesian Optimization](https://arxiv.org/abs/2602.02388) | 2026 · ICML 2026 · accepted | rankings, reference target; active elicitation, reward guidance | [Code](https://github.com/AnnonAnom125/annonAnomrepo) | Uses multi-choice preferential Bayesian optimization to search self-attention warps that move generated images toward a user target. |
...
| <a id="imagegem"></a>[ImageGem: In-the-wild Generative Image Interaction Dataset for Generative Model Personalization](https://arxiv.org/abs/2510.18433) | 2025 · ICCV 2025 · published | implicit history; user representation, adapter fine tuning | [Code](https://github.com/MAPS-research/imagegem) · [Project](https://maps-research.github.io/imagegem-iccv2025/) · [Data](https://huggingface.co/datasets/MAPS-research/ImageGem-images) · (partial) | Collects user-generated image and LoRA histories and demonstrates personalized editing directions in a shared LoRA weight space. |
| <a id="instant-preference-alignment"></a>[Instant Preference Alignment for Text-to-Image Diffusion Models](https://arxiv.org/abs/2508.17718) | 2026 · IEEE Transactions on Visualization and Computer Graphics · published | likes, natural language, reference target; prompt rewriting | Code: Not found as of 2026-09-21 | Extracts preferences from a selected reference image, enriches prompts and controls diffusion using global keywords and regional attention. |
...
| <a id="fabric"></a>[FABRIC: Personalizing Diffusion Models with Iterative Feedback](https://arxiv.org/abs/2307.10159) | 2023 · arXiv · preprint | likes dislikes, reference target; retrieval in context | [Code](https://github.com/sd-fabric/fabric) · [Project](https://sd-fabric.github.io/) | Injects liked and disliked reference-image features into diffusion self-attention across feedback rounds without model training. |
...
| [ImageGem](#imagegem) | Civitai uploader identities link generated images and LoRA usage.; Creation/usage histories; anonymous emoji counts do not identify individual reactors. | real | Paper Table 1: raw 57,245 users; filtered 4,916,134 images, 2,895,364 prompts and 242,118 LoRA checkpoints. | Retrieval and generation are separate; personalized generation uses proxy judgments. |
